...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long weatherTablelocationRowId;
        weatherTablelocationRowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherValues);

        assertTrue(weatherTablelocationRowId != -1);
